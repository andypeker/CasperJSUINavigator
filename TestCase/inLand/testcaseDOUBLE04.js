...
**  Three Case  **
******************/
casper.test.begin("FourDoubleCase", 1, function suite(test){

   this._result_cap_str = "../../TestCapture/Test_FourDoubleCase/";
	// 从这里开始
	casper.start("http://m.ctrip.com/", function() {
		  this.capture(this._result_cap_str + _TimeStamp() + ".png");
	}).then(function(){_TEST_double_T.call(this, 'BJS', 'SHA', '2014-10-12', '2014-10-21')});
	//	登出
