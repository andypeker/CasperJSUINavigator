...
function inter_D_A_T_Flt_Check2(){
...
*/
	...
	this.wait(500, function(){_Single.call(this);});
	this.wait(500, function(){Inter_DepartCity_Select.call(this);});
	this.wait(500, function(){Inter_ArriveCity_Select.call(this);});
